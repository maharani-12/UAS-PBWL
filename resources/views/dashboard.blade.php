            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <script>
                    const fetchData = async () => {
                        try {
                            const response = await fetch('/obats-count'); // Route defined in web.php
                    ...
                    const createChart = (data) => {
                        ...
                        new Chart(ctx, {
                            type: 'bar',
                            data: {
                                labels: ['Registered Madicine'],
                                datasets: [{
                                    label: 'Number of Madicine',
                                    data: [data.obatCount], // Adjust data accordingly
